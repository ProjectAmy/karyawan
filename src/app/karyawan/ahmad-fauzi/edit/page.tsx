...
export default function EditAhmadFauzi() {
  ...
  const handleSave = (e: React.FormEvent) => {
    e.preventDefault();
    window.location.href = "/karyawan/ahmad-fauzi";
  };
      ...
      <div className="flex flex-1 relative bg-gray-100">
        ...
        <main className="flex-1 flex flex-col items-center justify-center py-10">
          <form onSubmit={handleSave} className="bg-white p-8 rounded shadow-md w-full max-w-xl">
            ...
            <div className="mt-8">
              <h2 className="text-lg font-semibold mb-4 text-blue-700 text-center">Upload Ulang Dokumen</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="flex flex-col items-center">
                  <img src="https://dummyimage.com/200x120/cccccc/444444&text=KTP" alt="Preview KTP" className="rounded shadow mb-2 w-48 h-28 object-cover" />
                  <div className="w-full flex flex-col items-center">
                    <label className="w-full text-center font-bold text-base mb-1" htmlFor="fileKtp">Pilih File</label>
                    <input id="fileKtp" type="file" accept="image/*" className="mb-2 block mx-auto" />
                  </div>
                  <span className="text-gray-700 text-sm text-center block">Upload Foto KTP</span>
                </div>
                <div className="flex flex-col items-center">
                  <img src="https://dummyimage.com/200x120/cccccc/444444&text=KK" alt="Preview KK" className="rounded shadow mb-2 w-48 h-28 object-cover" />
                  <div className="w-full flex flex-col items-center">
                    <label className="w-full text-center font-bold text-base mb-1" htmlFor="fileKk">Pilih File</label>
                    <input id="fileKk" type="file" accept="image/*" className="mb-2 block mx-auto" />
                  </div>
                  <span className="text-gray-700 text-sm text-center block">Upload Foto KK</span>
                </div>
              </div>
            </div>
